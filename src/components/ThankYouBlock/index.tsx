...
export const ThankYouBlock: React.FC<ThankYouBlockProps> = ({ correctAnswers, totalQuestions, handleResetClick }) => {
  return (
    <div className="flex flex-col items-center">
      ...
      <Button onClick={handleResetClick} className="flex items-center self-center py-4 px-14 text-lg mt-10 bg-green rounded-2xl transition-all text-white min-lg:hover:bg-dark-green">Back to home</Button>
    </div>
  )
}